...
import win32.com as pythoncom
from win32.com.client import Dispatch
from win32.com.client import genpy, selecttlb, gencache
...
def GenerateFromTypeLibSpec(typelibInfo,
    ...
    for typelib, info in typelibs:
        gen = genpy.Generator(
            typelib, info.dll, progress, bBuildHidden=bBuildHidden)
...
def GenerateChildFromTypeLibSpec(child,
                                 typelibInfo,
                                 verboseLevel=None,
                                 progressInstance=None,
                                 bUnicodeToString=None):
    ...
    for typelib, info in typelibs:
        dir_name = gencache.GetGeneratedFileName(info.clsid, info.lcid,
                                                 info.major, info.minor)
