...
PR_PREDECESSOR_CHANGE_LIST = PROP_TAG(PT_BINARY,
                                      pidExchangeNonXmitReservedMin + 3)
...
PR_PUBLISH_IN_ADDRESS_BOOK = PROP_TAG(PT_BOOLEAN,
                                      pidExchangeXmitReservedMin + 6)
PR_RESOLVE_METHOD = PROP_TAG(PT_LONG, pidExchangeXmitReservedMin + 7)
PR_ADDRESS_BOOK_DISPLAY_NAME = PROP_TAG(PT_TSTRING,
                                        pidExchangeXmitReservedMin + 8)
...
PR_MOVE_TO_FOLDER_ENTRYID = PROP_TAG(PT_BINARY,
                                     pidExchangeXmitReservedMin + 20)
...
PR_SVR_GENERATING_QUOTA_MSG = PROP_TAG(PT_TSTRING,
                                       pidExchangeXmitReservedMin + 23)
...
PR_REPORT_DESTINATION_ENTRYID = PROP_TAG(PT_BINARY,
                                         pidMessageWriteableMin + 13)
